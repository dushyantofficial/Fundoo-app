...
use App\Models\Admin\Asign_Valet_Parking_DriverDataTable;
use App\Models\Admin\AssignDriver;
use Yajra\DataTables\EloquentDataTable;
use Yajra\DataTables\Services\DataTable;

class Assign_Valet_Parking_DriverDataTable extends DataTable
{
    /**
...
//                dd($record->user->status);
     ...
     *
     * @param \App\Models\Admin\Asign_Valet_Parking_DriverDataTable $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Assign_Valet_Parking_DriverDataTable $model)
    {
        $model = AssignDriver::where('type', config('constants.CATEGORY.valet_parking'));
...
//            ->addAction(['width' => '120px', 'printable' => false])
    ...
    {
        return 'Admin\Asign_Valet_Parking_Driver_' . date('YmdHis');
    }
}
