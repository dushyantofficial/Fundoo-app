...
class PickUp_Drop_DriverDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'admin.pickUp_drop_driver.datatables_actions')
     ...
     *
     * @param \App\Models\admin/PickUp_Drop_Driver $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(DriverExtended $model)
    {
        $model = DriverExtended::where('work_type', config('constants.CATEGORY.pickup-drop'))->whereHas('user', function ($q) {
    ...
    {
        return 'admin/PickUp_Drop_Driver_' . date('YmdHis');
    }
}
