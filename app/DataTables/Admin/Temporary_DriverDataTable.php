...
class Temporary_DriverDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'admin.temporary_driver.datatables_actions')
     ...
     *
     * @param \App\Models\admin/Temporary_Driver $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(DriverExtended $model)
    {
        $model = DriverExtended::where('work_type', config('constants.CATEGORY.temporary'))->whereHas('user', function ($q) {
    ...
    {
        return 'admin/Temporary_Driver_' . date('YmdHis');
    }
}
