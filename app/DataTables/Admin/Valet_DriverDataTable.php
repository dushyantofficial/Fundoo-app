...
class Valet_DriverDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'admin.valet_driver.datatables_actions')
     ...
     *
     * @param \App\Models\admin/Valet_Driver $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
public function query(DriverExtended $model)
{
    $model = DriverExtended::where('work_type', config('constants.CATEGORY.valet_parking'))->whereHas('user', function ($q) {
    ...
    {
        return 'admin/Valet_Driver_' . date('YmdHis');
    }
}
