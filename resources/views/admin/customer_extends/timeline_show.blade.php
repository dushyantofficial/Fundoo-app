                                ...
                                <div class="col-lg-8">
                                    <ul class="nav nav-pills">
                                        ...
                                        <li class="nav-item"><a class="nav-link text-dark" href="#cars"
                                                ...
                                                Cars</a></li>
                                        <li class="nav-item"><a class="nav-link text-dark" id="show_timeline"
                                                                href="#timeline"
                                                                data-toggle="tab"><i
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="timeline">
                                    @if($time_lines->count() > 0)
                                        ...
                                        {{--                                        <center><a href="{{route('all-timeline-show')}}?id={{request()->id}}" class="btn btn-warning text-center btn_1" ><i class="fas fa-sync"></i> All Show</a></center>--}}
...
@push('page_scripts')
    ...
    <script>
        $(document).ready(function () {
            var show_timeline = '<?php echo $doc; ?>';
            if (show_timeline == 'show_timeline') {
                $('#show_timeline').trigger('click');
            }
        });
    </script>
