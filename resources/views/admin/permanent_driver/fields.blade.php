...
<!-- Work Type Field -->
{{--@dd(config('constants.CATEGORY.permanent'))--}}
<div class="form-group col-sm-2">
    ...
    {{--            <option--}}
    {{--                value="{{ $value }}" @if(isset($driverExtended)){{ ($driverExtended->work_type==$value)? "selected" : "" }} @endif>--}}
    {{--                {{ $values }}--}}
    {{--            </option>--}}
    {{--        @endforeach--}}
    {{--    </select>--}}
    <input type="text" name="work_type" class="form-control" value="{{config('constants.CATEGORY.permanent')}}"
           @if(isset($driverExtended)){{ ($driverExtended->work_type==config('constants.CATEGORY.permanent'))? "selected" : "" }} @endif disabled>
    ...
    <div class="form-group">
        ...
        @if(isset($driverExtended))
            @if($driverExtended->license == '')
                <img src="{{asset('admin/dummy_image/no-image.jpg')}}" alt="user" style="width: 40px; height: 40px;">
            @else
                <img src="{{asset('storage/admin/images/'.$driverExtended->license)}}"
                     style="width: 40px; height: 40px;"
                     alt="user">
            @endif
        @endif
    ...
    <div class="form-group">
        ...
        @if(isset($driverExtended))
            @if($driverExtended->pancard == '')
                <img src="{{asset('admin/dummy_image/no-image.jpg')}}" alt="user" style="width: 40px; height: 40px;">
            @else
                <img src="{{asset('storage/admin/images/'.$driverExtended->pancard)}}"
                     style="width: 40px; height: 40px;"
                     alt="user">
            @endif
        @endif
    ...
    <div class="form-group">
        ...
        @if(isset($driverExtended))
            @if($driverExtended->light_bill == '')
                <img src="{{asset('admin/dummy_image/no-image.jpg')}}" alt="user" style="width: 40px; height: 40px;">
            @else
                <img src="{{asset('storage/admin/images/'.$driverExtended->light_bill)}}"
                     style="width: 40px; height: 40px;"
                     alt="user">
            @endif
        @endif
